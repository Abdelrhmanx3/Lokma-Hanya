          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-5 border-b border-zinc-200">
                ...
                >
                  <Cancel01Icon className="w-6 h-6" strokeWidth={3}/>
                </button>
              </div>
                      ...
                      >
                        <div className="relative w-20 h-20 rounded-2xl overflow-hidden shrink-0">
                          ...
                          <span className="absolute top-1 right-1 cursor-pointer" onClick={() =>
                            ...
                            <XIcon className="size-4 pointer-events-none" strokeWidth={4} />
                          </span>
                        </div>
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          ...
                          <div className="flex items-center justify-between mt-2">
                            <div className="flex items-center gap-3 bg-background rounded-full px-1 py-1">
                              ...
                              >
                                <MinusSignIcon className="w-3.5 h-3.5 pointer-events-none" strokeWidth={4} />
                              </button>
                              <Typography
                                size="sm"
                                weight="semibold"
                              ...
                              <button
                                ...
                                className="w-6 h-6 flex items-center justify-center rounded-full  transition-colors duration-300 cursor-pointer hover:bg-muted dark:hover:bg-white/25"
                              >
                                <Add01Icon className="w-3.5 h-3.5 pointer-events-none" strokeWidth={4} />
                              </button>
                            </div>
